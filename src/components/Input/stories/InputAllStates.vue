<template>
  <div style="display: flex; align-items: center; gap: 16px; flex-wrap: wrap; padding: 16px;">
    <Input id="all-states-hint-input" type="text" label="Hint" aria-label="Hint input" hint="Hint as an example"
    ...
    <Input id="all-states-required-input" type="text" label="Required" aria-label="Required input" required
