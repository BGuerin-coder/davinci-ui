...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          `The \`DvInput\` component is a versatile form control for user input. It supports various types (text, password, email, etc.), sizes, and states (disabled, error). It can also include icons and clearable functionality.
